            ...
            <div className='pb-6 flex flex-col gap-5'>
                ...
                <div className='w-full flex justify-between items-center'>
                    <div className='w-[830px] flex flex-col gap-10'>
                        ...
                        <p>
                            <span>Living Space:</span> This charming cabin boasts a spacious living area adorned with rustic decor and modern amenities. Enjoy the warmth of the wood-burning fireplace, relax on the plush sofas, and make yourself at home with our entertainment center featuring a flat-screen TV, WiFi, and more.
                        </p>
                        <p>
                            <span>Bedrooms:</span> With 3 beautifully appointed bedrooms, our cabin comfortably accommodates up to [number of guests]. Each room is furnished with luxurious bedding and unique woodland-inspired touches to ensure a restful slumber.
                        </p>
                        <span className='text-[#00C29F]'>
                            Show more
                        </span>
                    </div>
